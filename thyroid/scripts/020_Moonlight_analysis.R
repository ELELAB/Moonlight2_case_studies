...
Filt_Basal_raw <- get(load("../data/rawdata/THCA_dataFilt_HUGO.rda"))
Maf_Basal <- read.csv("../data/rawdata/mutations_THCA.csv")
...
save(GRN_Basal, file = "../data/GRN_Thyroid.rda")
...
save(URA_Basal, file = "../data/URA_Thyroid.rda")

# PRA ------
PRA_Basal <- PRA(dataURA = URA_Basal,
                  BPname = c("proliferation of cells", "apoptosis"),
                  thres.role = 0)
save(PRA_Basal, file = "../data/PRA_Thyroid.rda")
...
save(DMA_Basal, file = "../data/DMA_Thyroid.rda")
